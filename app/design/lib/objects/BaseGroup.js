...
export class BaseGroup extends Group {
  ...
  serializeToJSON() {
    ...
    dataToSerialize.objectType = this.className;
    ...
    if (this.lockXToPolygon && typeof this.lockXToPolygon.TargetObject?.canvasID !== 'undefined') {
      dataToSerialize.LockXInfo = {
        ...
        sourcePoint: this.lockXToPolygon.sourcePoint,
        targetPoint: this.lockXToPolygon.targetPoint,
        spacingX: this.lockXToPolygon.spacing,
      };
    }
    ...
    if (this.lockYToPolygon && typeof this.lockYToPolygon.TargetObject?.canvasID !== 'undefined') {
      dataToSerialize.LockYInfo = {
        ...
        sourcePoint: this.lockYToPolygon.sourcePoint,
        targetPoint: this.lockYToPolygon.targetPoint,
        spacingY: this.lockYToPolygon.spacing,
      };
    }
