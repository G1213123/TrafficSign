...
//import { DividerMargin } from './template.js';
//import { MainRoadSymbol } from './mainRoute.js';
//import { SideRoadSymbol } from './sideRoute.js';
...
const ChtDestinations = [{ "Hong Kong Island": ["香港", "香港(東)", "香港(中)", "香港(西)", "香港仔", "鴨脷洲", "銅鑼灣", "中區", "柴灣", "舂坎角", "數碼港", "杏花邨", "跑馬地", "堅尼地城", "康怡", "半山", "北角", "薄扶林", "鰂魚涌", "淺水灣", "西灣", "西灣河", "西營盤", "筲箕灣", "石澳", "石塘咀", "上環", "壽臣山", "赤柱", "小西灣", "大坑", "太古城", "山頂", "華富", "灣仔", "灣仔(北)", "黃竹坑"] },
 ...
 */
function createTemplateSign(templateName, x = null, y = null) {
    ...
    const centerY = y || vpt.y; switch (templateName) {
        case 'Flag Sign':
            return createBasicGantry(centerX, centerY, 100, 'white');

        case 'Stack Sign':
            return createStackSign(centerX, centerY, 100, 'white');

        case 'Roundabout Sign':
            return createRoundaboutDirections(centerX, centerY, 100, 'white');

        case 'Diverge Sign':
            return createInterchangeDirections(centerX, centerY, 250, 'white');

        case 'Lane Sign':
            return createMultiLaneExit(centerX, centerY, 100, 'white');

        case 'Spiral Roundabout Sign':
            return createSpiralRoundaboutSign(centerX, centerY, 100, 'white');

        case 'Gantry Sign':
            return createGantrySign(centerX, centerY, 250, 'white');
 ...
 */
function createBasicGantry(centerX, centerY, xHeight, color) {
    try {
 ...
 */
function createGantrySign(centerX, centerY, xHeight, color) {
    try {
 ...
 */
function createStackSign(centerX, centerY, xHeight, color) {
    try {
 ...
 */
function createRoundaboutDirections(centerX, centerY, xHeight, color) {
    try {
 ...
 */
function createInterchangeDirections(centerX, centerY, xHeight, color) {
    try {
 ...
 */
function createMultiLaneExit(centerX, centerY, xHeight, color) {
    try {
 ...
 */
function createSpiralRoundaboutSign(centerX, centerY, xHeight, color) {
    try {
