...
async function buildObjectsFromJSON(jsonStringsArray) {
    ...
    const arrayPropertiesToRemapItemsById = ['underline', 'anchoredPolygon', 'sideRoad', 'widthObjects', 'heightObjects',  'leftObjects', 'aboveObjects', 'rightObjects', 'belowObjects', 'VDivider', 'HDivider'];
