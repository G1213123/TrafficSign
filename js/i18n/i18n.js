...
const dictionaries = {
  ...
  'Open the Road Sign Factory application and explore the intuitive side panel interface and grid canvas designed for precision and ease of use.': '開啟 Road Sign Factory，體驗直覺的側邊面板介面與精準的格線畫布。',
  'Select from our comprehensive template library or start from scratch. Add text, routes, symbols, and shapes using our powerful editing tools.': '從完整的範本庫中選擇，或從頭開始。使用強大的編輯工具加入文字、路線、符號與圖形。',
  ...
  'Example of Flag Sign': '旗形標誌範例',
  'Flag Sign Tutorial': '旗形標誌教學',
  'Flag Sign Example': '旗形標誌示例',
  'Example of Diverging Sign': '分岔路標誌範例',
  'Diverging Sign Tutorial': '分岔路標誌教學',
  'Diverging Sign Example': '分岔路標誌示例',
  ...
  'Learn More': '瞭解更多',
    ...
    'x Height': 'x 高度',
    'mm': '毫米',
    'Enter spacing in X \n (Leave empty if no need for axis):': '輸入X軸間隔(如無需固定則留空白):',
    'Enter spacing in Y \n (Leave empty if no need for axis):': '輸入Y軸間隔(如無需固定則留空白):',
    'Black': '黑色',
    'White': '白色',
    'Message Colour': '訊息顏色',
    'Text Font': '英文字體',
