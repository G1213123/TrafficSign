...
const dictionaries = {
  zh: {
    ...
    // Border panel
    'Color Scheme': '色彩方案',
    'Add Divider to Border': '新增分隔線至邊框',
    'Stack Divider': '長型標誌分隔線',
    'Gantry Divider': '架空標誌分隔線',
    'Gantry Line': '門架水平線',
    'Lane Line': '行車線分隔線',
  ...
  'Click inside the border to place divider': '在邊框內點擊以放置分隔線',
    ...
    'Main Road Angle': '主路角度',
    'Main Road Sub-type': '主路子類型',
