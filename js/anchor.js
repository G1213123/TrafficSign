...
import { selectObjectHandler } from './sidebar.js';

// Event handler for showing/hiding sidebar
let ShowHideSideBarEvent;
let selectedArrow;

export function initAnchor(sidebarEvent) {
  ShowHideSideBarEvent = sidebarEvent;
...
export function setSelectedArrow(arrow) {
  selectedArrow = arrow;
}

export async function anchorShape(inputShape1, inputShape2, options = {}, sourceList = []) {
