...
let FormSettingsComponent = {
  ...
  settingsPanelInit: function () {
    ...
    if (parent) {
      ...
      GeneralHandler.createButton('reset-settings', 'Reset to Defaults', buttonContainer, 'input',
  ...
  loadSettings: function() {
    try {
      ...
      if (savedSettings) {
        ...
        // No saved settings, apply defaults from defaultGridSettings and canvas
        if (defaultGridSettings) {
          GeneralSettings.showGrid = defaultGridSettings.showGrid;
          GeneralSettings.gridColor = defaultGridSettings.gridColor;
          GeneralSettings.gridSize = defaultGridSettings.gridSize;
        }
        if (canvas) {
          GeneralSettings.backgroundColor = canvas.backgroundColor;
        }
        FormSettingsComponent.applyAllSettings();
        FormSettingsComponent.updateSettingsUI();
      }
