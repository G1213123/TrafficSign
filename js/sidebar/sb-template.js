...
let FormTemplateComponent = {
  ...
  createBasicGantry: async function(centerX, centerY, xHeight, color) {
    try {
      ...
      const leftDestinationText = new TextObject({
        text: 'Mong Kok',
        xHeight: xHeight,
        font: 'TransportHeavy',
        color: color,
      ...
      const rightDestinationText = new TextObject({
        text: 'Kowloon City',
        xHeight: xHeight,
        font: 'TransportHeavy',
        color: color,
      ...
      // Create horizontal lines for both sides
      await HLineCreate(
        [leftChineseText],
        [leftArrow],
        null,
      ...
      // Anchor text objects
      anchorShape(leftDestinationText, leftChineseText, {
        vertexIndex1: 'E1',
        vertexIndex2: 'E7',
        spacingX: 0,
        spacingY: 0
      ...
      anchorShape(rightDestinationText, rightChineseText, {
        vertexIndex1: 'E1',
        vertexIndex2: 'E7',
        spacingX: 0,
        spacingY: 0
      ...
      const allObjects = [
        leftDestinationText, leftChineseText, leftArrow,
        rightDestinationText, rightChineseText, rightArrow,
  ...
  createStackSign: async function(centerX, centerY, xHeight, color) {
    try {
      ...
      const topDestinationText = new TextObject({
        text: 'Central & Western District',
        xHeight: xHeight,
        font: 'TransportHeavy',
        color: color,
        left: centerX - 250,
      ...
      const botDivider = canvasObject[canvasObject.length - 1];
      
      // Anchor text objects in pairs
      anchorShape(topDestinationText, topChineseText, {
        vertexIndex1: 'E1',
        vertexIndex2: 'E7',
        spacingX: 0,
        spacingY: 0
  ...
  createRoundaboutDirections: async function(centerX, centerY, xHeight, color) {
    try {
      // Create roundabout symbol at center
      await drawLabeledSymbol('RoundaboutSymbol', {
        x: centerX,
        y: centerY,
        xHeight: xHeight * 2,
        angle: 0,
      ...
      const roundaboutSymbol = canvasObject[canvasObject.length - 1];
      
      // Create destination texts around the roundabout
      const topDestinationText = new TextObject({
        text: 'Shatin',
        xHeight: xHeight,
        font: 'TransportHeavy',
      ...
      const bottomDestinationText = new TextObject({
        text: 'Kowloon Tong',
        xHeight: xHeight,
        font: 'TransportHeavy',
        color: color,
      ...
      const bottomChineseText = new TextObject({
        text: '九龍塘',
        xHeight: xHeight,
        font: 'TransportHeavy',
        color: color,
      ...
      anchorShape(bottomDestinationText, bottomChineseText, {
        vertexIndex1: 'E1',
        vertexIndex2: 'E7',
        spacingX: 0,
        spacingY: 0
      ...
      const allObjects = [
        roundaboutSymbol, 
        topDestinationText, topChineseText,
        rightDestinationText, rightChineseText,
        bottomDestinationText, bottomChineseText,
        leftDestinationText, leftChineseText
      ];
